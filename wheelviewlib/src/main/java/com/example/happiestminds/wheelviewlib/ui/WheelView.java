...
import com.example.happiestminds.wheelviewlib.adapter.WheelAdapter;
import com.example.happiestminds.wheelviewlib.transformer.FadingSelectionTransformer;
import com.example.happiestminds.wheelviewlib.transformer.ScalingItemTransformer;
import com.example.happiestminds.wheelviewlib.transformer.WheelItemTransformer;
import com.example.happiestminds.wheelviewlib.transformer.WheelSelectionTransformer;
...
public class WheelView extends View {
    ...
    private Drawable mWheelDrawable_Cricle;
    ...
    /**
     * To determing whether to draw the circle outline or not
     */
    private boolean mIsCricleDrawable;
    ...
    public void setCricleDrawable(boolean mIsCricleDrawable) {
        this.mIsCricleDrawable = mIsCricleDrawable;
    }
    ...
    private void setWheelBounds(int width, int height) {
        ...
        if (mWheelDrawable != null) {
            ...
            mWheelDrawable_Cricle.setBounds(mWheelBounds.getBoundingRectSmall());
        }
    }
    ...
    public void setWheelDrawable(Drawable drawable) {
        ...
        mWheelDrawable_Cricle = drawable;
    ...
    private void drawCircle(Canvas canvas) {
        if (!mIsCricleDrawable)
            return;

        Paint p = new Paint();
        p.setStyle(Paint.Style.STROKE);
        p.setAntiAlias(true);
        canvas.drawCircle(mWheelBounds.mCenterX, mWheelBounds.mCenterY, (mWheelBounds.mRadius - 105), p);
    }
