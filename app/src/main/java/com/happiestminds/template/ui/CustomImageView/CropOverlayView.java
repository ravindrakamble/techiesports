...
import com.happiestminds.template.service.genericservices.imageutilservices.imagecrophandler.Handle;
import com.happiestminds.template.service.genericservices.imageviewcroppingutils.AspectRatioUtil;
import com.happiestminds.template.service.genericservices.imageviewcroppingutils.HandleUtil;
import com.happiestminds.template.service.genericservices.imageviewcroppingutils.PaintUtil;
...
public class CropOverlayView extends View {
    ...
    private void initCropWindow(Rect bitmapRect) {
        ...
        if (bitmapRect != null && (bitmapRect.width() == 0 || bitmapRect.height() == 0)) {
            return;
        }
